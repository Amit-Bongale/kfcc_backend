...
public class IdCardRequestsController {
    ...
    @PostMapping(path = "/apply/{membershipId}", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
    public IdCardResponseDTO applyForId(
        ...
        return idCardRequestService.requestIdCard(membershipId , user  ,applicantPhoto);
